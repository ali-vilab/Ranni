...
class LatentDiffusion(DDPM):
    ...
    def get_learned_conditioning(self, c):
        ...
        if self.cond_stage_model is None: # hack here to input pre-extracted null cond
            return c
    ...
    def encode_first_stage(self, x):
        # self.first_stage_model = self.first_stage_model.to(x.device)
...
class ImageEmbeddingConditionedLatentDiffusion(LatentDiffusion):
    ...
    def get_input(self, batch, k, cond_key=None, bs=None, **kwargs):
        ...
        # self.embedder = self.embedder.to(img.device)
